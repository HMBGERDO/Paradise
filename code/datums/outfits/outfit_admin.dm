...
/datum/outfit/admin/syndicate/operative/lone
	l_pocket = /obj/item/pinpointer // lone ops needs pinpointer to disk and station bomb. As default station pinpointer.
