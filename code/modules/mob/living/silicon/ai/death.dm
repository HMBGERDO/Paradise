/mob/living/silicon/ai/death(gibbed)
	...
	if(doomsday_device)
		...
		if(SSshuttle.emergency.mode == SHUTTLE_STRANDED)
			...
			GLOB.priority_announcement.Announce("Враждебное окружение разрешено. У вас есть 3 минуты, чтобы погрузиться на шаттл.", "Приоритетное Объявление", 'sound/AI/eshuttle_dock.ogg')
