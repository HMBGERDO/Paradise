...
/mob/living/silicon/ai/verb/announcement_help()
	...
	dat += {"<meta charset="UTF-8">Here is a list of words you can type into the 'Announcement' button to create sentences to vocally announce to everyone on the same level at you.<BR> \
